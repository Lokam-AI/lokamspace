...
const mockCampaigns: Campaign[] = [
  { id: "1", name: "Spring Service Reminders", organizationId: "org1", dateCreated: "2024-03-01", callCount: 45 },
  { id: "2", name: "Oil Change Follow-ups", organizationId: "org1", dateCreated: "2024-03-15", callCount: 32 },
  { id: "3", name: "Brake Inspection Campaign", organizationId: "org1", dateCreated: "2024-03-20", callCount: 28 },
  { id: "4", name: "Imported - 2024-03-25", organizationId: "org1", dateCreated: "2024-03-25", callCount: 156 },
  { id: "5", name: "Winter Maintenance Check", organizationId: "org1", dateCreated: "2024-03-10", callCount: 67 },
  { id: "demo", name: "Demo Campaign", organizationId: "org1", dateCreated: "2024-03-01", callCount: 12 }
];
...
const Calls = () => {
  ...
  const activeCampaign = campaigns.find(c => c.id === filters.campaignId && filters.campaignId !== "all");
          ...
          <div className="h-full flex flex-col">
            ...
            <div className="bg-card border-b border-border px-6 py-4 flex-shrink-0">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <h1 className="text-3xl font-bold text-foreground mb-2">Feedback Calls Management</h1>
                  <p className="text-muted-foreground">Manage customer feedback calls, track progress, and review completed interactions</p>
                  {activeCampaign && (
            ...
            <div className="flex-1 overflow-auto bg-background">
              <div className="p-6 space-y-6">
                ...
                <div className="bg-card rounded-lg shadow-sm border border-border">
                  <CallsFilters filters={filters} onFiltersChange={setFilters} campaigns={campaigns} />
                </div>
                  ...
                  <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                    ...
                    <div className="p-6 bg-background">
                      <TabsContent value="ready" className="mt-0">
                        <ReadyForCallTab filters={filters} onCallAction={handleCallAction} />
                      </TabsContent>

                      <TabsContent value="missed" className="mt-0">
                        <MissedCallsTab filters={filters} onRetryCall={handleCallAction} />
                      </TabsContent>

                      <TabsContent value="completed" className="mt-0">
                        <CompletedCallsTab filters={filters} onViewDetails={handleViewDetails} />
                      </TabsContent>

                      <TabsContent value="demo" className="mt-0">
                        <DemoCallTab campaigns={campaigns} onViewDetails={handleViewDetails} />
                      </TabsContent>
                    </div>
                  </Tabs>
                </div>
